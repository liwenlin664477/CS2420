...
public class CS2420Class {
	...
	public void addScore(int uNID, double score, String category) {
		CS2420Student testStudent = this.lookup(uNID);
		if (testStudent != null) {
	...
	public ArrayList<EmailAddress> getContactList() {
		ArrayList<EmailAddress> allEmails = new ArrayList<EmailAddress>();
		for (CS2420Student student: studentList) {
			if (!(allEmails.contains(student.getContactInfo()))) {
				allEmails.add(student.getContactInfo());
			}
		}
		return allEmails;
	}
