...
public class CS2420ClassGenericTester {
	...
	@Test
	public void testVerySmallOrderedByUNID() {
		CS2420ClassGeneric<MailingAddress> test = new CS2420ClassGeneric<MailingAddress>();
		ArrayList<CS2420StudentGeneric<MailingAddress>> expect = new ArrayList<CS2420StudentGeneric<MailingAddress>>();
		
		CS2420StudentGeneric<MailingAddress> actual1 = new CS2420StudentGeneric<MailingAddress>("Jane", "Doe", 4545454,
				new MailingAddress("101 Cherry St.", "Lebanon", "OH", 45036));

		CS2420StudentGeneric<MailingAddress> actual2 = new CS2420StudentGeneric<MailingAddress>("Drew", "Hall", 2323232,
				new MailingAddress("156 Main St.", "Lebanon", "VA", 24266));

		CS2420StudentGeneric<MailingAddress> actual3 = new CS2420StudentGeneric<MailingAddress>("Riley", "Nguyen",
				1010101, new MailingAddress("2044 State St.", "Lebanon", "PA", 17042));

		test.addStudent(actual1);
		test.addStudent(actual2);
		test.addStudent(actual3);
		
		expect.add(actual3);
		expect.add(actual2);
		expect.add(actual1);

		ArrayList<CS2420StudentGeneric<MailingAddress>> orderedByUNID = test.getOrderedByUNID();
		assertTrue(expect.equals(orderedByUNID));
	}

	@Test
	public void testVerySmallOrderedByName() {
		CS2420ClassGeneric<MailingAddress> test = new CS2420ClassGeneric<MailingAddress>();
		ArrayList<CS2420StudentGeneric<MailingAddress>> expect = new ArrayList<CS2420StudentGeneric<MailingAddress>>();
		
		CS2420StudentGeneric<MailingAddress> actual1 = new CS2420StudentGeneric<MailingAddress>("Jane", "Doe", 1010101,
				new MailingAddress("101 Cherry St.", "Lebanon", "OH", 45036));

		CS2420StudentGeneric<MailingAddress> actual2 = new CS2420StudentGeneric<MailingAddress>("Drew", "Allen", 2323232,
				new MailingAddress("156 Main St.", "Lebanon", "VA", 24266));
		
		CS2420StudentGeneric<MailingAddress> actual3 = new CS2420StudentGeneric<MailingAddress>("Riley", "Nguyen",
				4545454, new MailingAddress("2044 State St.", "Lebanon", "PA", 17042));
		...
		ArrayList<CS2420StudentGeneric<MailingAddress>> orderedByName = test.getOrderedByName();
		assertTrue(expect.equals(orderedByName));
	}

	@Test
	public void testVerySmallOrderedByScore() {
		CS2420ClassGeneric<MailingAddress> test = new CS2420ClassGeneric<MailingAddress>();
		ArrayList<CS2420StudentGeneric<MailingAddress>> expect = new ArrayList<CS2420StudentGeneric<MailingAddress>>();
		
		CS2420StudentGeneric<MailingAddress> actual1 = new CS2420StudentGeneric<MailingAddress>("Jane", "Doe", 1010101,
				new MailingAddress("101 Cherry St.", "Lebanon", "OH", 45036));
		actual1.addScore( 86.5, "assignment");
		actual1.addScore( 75, "exam");
		actual1.addScore( 90, "lab");
		actual1.addScore( 89.2, "quiz");

		CS2420StudentGeneric<MailingAddress> actual2 = new CS2420StudentGeneric<MailingAddress>("Drew", "Hall", 2323232,
				new MailingAddress("156 Main St.", "Lebanon", "VA", 24266));
		actual2.addScore(99, "assignment");
		actual2.addScore(75, "exam");
		actual2.addScore(80, "lab");
		actual2.addScore(67.7, "quiz");
		
		
		
		CS2420StudentGeneric<MailingAddress> actual3 = new CS2420StudentGeneric<MailingAddress>("Riley", "Nguyen",
				4545454, new MailingAddress("2044 State St.", "Lebanon", "PA", 17042));
		actual3.addScore( 86.5, "assignment");
		actual3.addScore( 100, "exam");
		actual3.addScore( 100, "lab");
		actual3.addScore( 89.2, "quiz");
		
		test.addStudent(actual1);
		test.addScore(1010101, 86.5, "assignment");
		test.addScore(1010101, 75, "exam");
		test.addScore(1010101, 90, "lab");
		test.addScore(1010101, 89.2, "quiz"); // 83.67
		
		test.addStudent(actual2);
		test.addScore(2323232, 99, "assignment");
		test.addScore(2323232, 75, "exam");
		test.addScore(2323232, 80, "lab");
		test.addScore(2323232, 67.7, "quiz"); //87.07
		
		test.addStudent(actual3);
		test.addScore(4545454, 86.5, "assignment");
		test.addScore(4545454, 100, "exam");
		test.addScore(4545454, 100, "lab");
		test.addScore(4545454, 89.2, "quiz");//92.17
		
		expect.add(actual2);
		expect.add(actual3);

		ArrayList<CS2420StudentGeneric<MailingAddress>> orderedByScore = test.getOrderedByScore(85.00);
		assertTrue(expect.equals(orderedByScore));
	}
